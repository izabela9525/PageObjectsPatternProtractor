...
var AddCustomerDetails = function(){
    ...
    this.gotoAddCustomer = function(){
        element(by.xpath(OR.locators.addcustomerdetailspage.addcustomerbutton)).click();
        return this;
    };
    ...
    this.addCustomerInfo = function(fname,lname,postcode){
        ...
        element(by.xpath(OR.locators.addcustomerdetailspage.fName)).sendKeys(fname);
        element(by.xpath(OR.locators.addcustomerdetailspage.lName)).sendKeys(lname);
        element(by.xpath(OR.locators.addcustomerdetailspage.pCode)).sendKeys(postcode);
